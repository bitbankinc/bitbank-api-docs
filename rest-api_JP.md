...
- [Private REST API一覧 (2021-10-05)](#private-rest-api%E4%B8%80%E8%A6%A7-2021-10-05)
...
------------ | ------------ | ------------
asset | string | アセット名: `jpy`,`btc`, `xrp`, `ltc`, `eth`, `mona`, `bcc`, `xlm`, `qtum`, `bat`, `omg`, `xym`
...
Name | Type | Mandatory | Description
------------ | ------------ | ------------ | ------------
asset | string | YES | アセット名: `btc`, `xrp`, `ltc`, `eth`, `mona`, `bcc`, `xlm`, `qtum`, `bat`, `omg`, `xym`
...
------------ | ------------ | ------------
uuid | string | 出金アカウントのID
asset | string | アセット名: `btc`, `xrp`, `ltc`, `eth`, `mona`, `bcc`, `xlm`, `qtum`, `bat`, `omg`, `xym`
