...
- [Public API一覧 (2022-01-25)](#public-api%E4%B8%80%E8%A6%A7-2022-01-25)
...
Name | Type | Description
------------ | ------------ | ------------
pair | string | 通貨ペア(JPYペアのみ): `btc_jpy`, `xrp_jpy`, `ltc_jpy`, `eth_jpy`, `mona_jpy`, `bcc_jpy`, `xlm_jpy`, `qtum_jpy`, `bat_jpy`, `omg_jpy`, `xym_jpy`, `xym_btc`, `link_jpy`, `link_btc`, `mkr_jpy`, `mkr_btc`
sell | string | 現在の売り注文の最安値
buy | string | 現在の買い注文の最高値
high | string | 過去24時間の最高値取引価格
low | string | 過去24時間の最安値取引価格
